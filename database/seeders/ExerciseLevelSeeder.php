...
class ExerciseLevelSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $exercise2 = DB::table('exercises')->insertGetId([
            ...
            'difficulty' => 2,
            'options' => json_encode([
                ['id' => 1, 'image' => '/images/apple.webp', 'name' => 'Apel', 'category' => 'fruit'],
                ['id' => 2, 'image' => '/images/banana.webp', 'name' => 'Pisang', 'category' => 'fruit'],
                ['id' => 3, 'image' => '/images/sword.webp', 'name' => 'Pedang', 'category' => 'animal'],
                ['id' => 4, 'image' => '/images/orange.webp', 'name' => 'Jeruk', 'category' => 'fruit'],
            ]),
            'created_at' => now(),
            'updated_at' => now(),
        ]);
